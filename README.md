...
7. Add New Relic to your application's main module (NodeJs app entry point - usually `index.ts/js` - example [here](newrelic-nextjs-integration/blob/main/server/index.ts#L1))
